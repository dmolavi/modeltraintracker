<?php
	...
	$query = "SELECT * FROM roadnames r ORDER BY r.r_roadname";
...
<script type="text/javascript"> 
	$(function(){
		...
		oTable = $('#roadname_table').dataTable({
			"bFilter": false,
			"bJQueryUI": true,
			"iDisplayLength" : 25,
			"sDom": '<"H"lfr>t<"F"ip>',
			...
			sAddURL: "add.php",
			sSelectedRowClass: "",
			oAddNewRowButtonOptions: {	label: "Add new roadname",
										icons: {primary:'ui-icon-plus'}},
			oAddNewRowFormOptions: {	title: 'Add new roadname',
										width: 500,
										modal: true},
...
?>
	<div id="content">
		...
		<form id="formAddNewRow" action="#">
			...
			<label for="roadname">Roadname:</label>&nbsp;&nbsp;
			<input name="roadname" id="roadname" type="text" value="" size="15" maxlength="50" />
			<br />
			<input type="hidden" name="ref" value="roadname" />
		</form>	
		<div id="table_box">
		<table class="list datatable" id="roadname_table">
			<thead>
				<tr>
					<th>Roadname</th>
				</tr>
