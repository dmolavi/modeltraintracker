...
2. Move add manufacturer/type to add item dialog box.
    - Ajax-ify the add (DONE) & edit (need to pre-populate) dialogs
*/
								...
								open: function() {
									...
									$.ajax({
										...
										success: function(data) {
											$("#description").val(data.i_description);
											$("#scale").val(data.i_scale);
											...
											$("#manufacturer").val(data.i_manufacturer);					
											$("#roadname").val(data.i_roadname);
											$("#value").val(data.i_value);
											$("#type").val(data.i_type);
